...
<head>
    ...
    <link rel="stylesheet" href="/WebsiteBanDoNoiThat/static/client/css/bootstrap.min.css">
    <!-- Owl Carousel min css -->
    <link rel="stylesheet" href="/WebsiteBanDoNoiThat/static/client/css/owl.carousel.min.css">
    <link rel="stylesheet" href="/WebsiteBanDoNoiThat/static/client/css/owl.theme.default.min.css">
    <!-- This core.css file contents all plugings css file. -->
    <link rel="stylesheet" href="/WebsiteBanDoNoiThat/static/client/css/core.css">
    <!-- Theme shortcodes/elements style -->
    <link rel="stylesheet" href="/WebsiteBanDoNoiThat/static/client/css/shortcode/shortcodes.css">
    <!-- Theme main style -->
    <link rel="stylesheet" href="/WebsiteBanDoNoiThat/static/client/style.css">
    <!-- Responsive css -->
    <link rel="stylesheet" href="/WebsiteBanDoNoiThat/static/client/css/responsive.css">
    <!-- User style -->
    <link rel="stylesheet" href="/WebsiteBanDoNoiThat/static/client/css/custom.css">


    <!-- Modernizr JS -->
    <script src="/WebsiteBanDoNoiThat/static/client/js/vendor/modernizr-3.5.0.min.js"></script>
</head>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="copyright__inner">
                                ...
                                <a href="#"><img src="/WebsiteBanDoNoiThat/static/client/images/others/shape/paypol.png" alt="payment images"></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="/WebsiteBanDoNoiThat/static/client/js/vendor/jquery-3.2.1.min.js"></script>
    <!-- Bootstrap framework js -->
    <script src="/WebsiteBanDoNoiThat/static/client/js/bootstrap.min.js"></script>
    <!-- All js plugins included in this file. -->
    <script src="/WebsiteBanDoNoiThat/static/client/js/plugins.js"></script>
    <script src="/WebsiteBanDoNoiThat/static/client/js/slick.min.js"></script>
    <script src="/WebsiteBanDoNoiThat/static/client/js/owl.carousel.min.js"></script>
    <!-- Waypoints.min.js. -->
    <script src="/WebsiteBanDoNoiThat/static/client/js/waypoints.min.js"></script>
    <!-- Main js file that contents all jQuery plugins activation. -->
    <script src="/WebsiteBanDoNoiThat/static/client/js/main.js"></script>
